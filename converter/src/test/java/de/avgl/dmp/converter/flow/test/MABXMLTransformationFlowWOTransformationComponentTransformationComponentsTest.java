 ...
 * @author tgaengler
 */
public class MABXMLTransformationFlowWOTransformationComponentTransformationComponentsTest extends AbstractXMLTransformationFlowTest {

	public MABXMLTransformationFlowWOTransformationComponentTransformationComponentsTest() {

		super("task.wo.transformationcomponenttransformationcomponents.json", "task-result.wo.transformationcomponent.json", "datensatz", "http://www.ddb.de/professionell/mabxml/mabxml-1.xsd", "test-mabxml.xml");
	}
