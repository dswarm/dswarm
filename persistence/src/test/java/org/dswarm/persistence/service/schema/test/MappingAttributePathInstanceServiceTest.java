...
public class MappingAttributePathInstanceServiceTest extends
	...
	private MappingAttributePathInstanceServiceTestUtils mapiu;
	...
	protected void initObjects() {
		super.initObjects();
		mapiu = new MappingAttributePathInstanceServiceTestUtils();
	...
	public void testSimpleMappingAttributePathInstance() throws Exception {
		...
		final String pathElementTitle = "http://purl.org/dc/terms/title";
		final String pathElementHasPart = "http://purl.org/dc/terms/hasPart";
		
		MappingAttributePathInstance mapi = mapiu.getAttributePathInstance( pathElementTitle, pathElementHasPart, pathElementTitle );
...
//		System.out.println("attribute hasPart = '" + dctermsHasPart.toString());
		...
		final MappingAttributePathInstance updatedMappingAttributePathInstance = updateObjectTransactional(mappingAttributePathInstance)
				.getObject();
