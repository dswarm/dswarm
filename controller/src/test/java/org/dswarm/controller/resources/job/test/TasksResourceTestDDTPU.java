...
public class TasksResourceTestDDTPU extends AbtractExportOnTheFlyTasksResourceTest {

	private static final Logger LOG = LoggerFactory.getLogger(TasksResourceTestDDTPU.class);

	public TasksResourceTestDDTPU() {
