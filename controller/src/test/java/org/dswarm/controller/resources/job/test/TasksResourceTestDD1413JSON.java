...
public class TasksResourceTestDD1413JSON extends AbtractExportOnTheFlyTasksResourceTest {

	private static final Logger LOG = LoggerFactory.getLogger(TasksResourceTestDD1413JSON.class);
	...
	public TasksResourceTestDD1413JSON() {

		super("dd-1413/task.json",
				"dd-1387/input.xml",
				"Publisher",
				ConfigurationStatics.SPRINGER_JOURNALS_STORAGE_TYPE,
				"dd-1413/json.result.json",
				"01",
				true,
