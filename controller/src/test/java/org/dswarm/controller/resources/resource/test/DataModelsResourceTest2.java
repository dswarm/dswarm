...
public class DataModelsResourceTest2 extends
	...
	public void testWrongData() throws Exception {
		...
		// prepare resource
		final String resourceJSONString = DMPPersistenceUtil.getResourceAsString("test-mabxml-resource2.csv.json");
		...
		Assert.assertEquals(
				"{\"status\":\"nok\",\"status_code\":500,\"error\":\" 1; Content is not allowed in prolog.\"}",
				body);
