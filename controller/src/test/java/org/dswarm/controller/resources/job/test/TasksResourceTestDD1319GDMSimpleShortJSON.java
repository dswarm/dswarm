...
public class TasksResourceTestDD1319GDMSimpleShortJSON extends AbtractExportOnTheFlyTasksResourceTest {

	private static final Logger LOG = LoggerFactory.getLogger(TasksResourceTestDD1319GDMSimpleShortJSON.class);
	...
	public TasksResourceTestDD1319GDMSimpleShortJSON() {

		super("dd-1387/task.json",
				"dd-1387/input.xml",
				"Publisher",
				ConfigurationStatics.XML_STORAGE_TYPE,
				"dd-1319/gdm-simple-short.json.result.json",
				"01",
				true,
				MediaTypeUtil.GDM_SIMPLE_SHORT_JSON_TYPE);
	}
