...
public class AttributesResourceTest extends BasicResourceTest<AttributesResourceTestUtils, AttributeService, ProxyAttribute, Attribute, Long> {
	...
	public void testPUTObject() throws Exception {
		...
		final Attribute modifiedAttribute = objectMapper.readValue(attributeJSONString, Attribute.class);

		updateAttribute = pojoClassResourceTestUtils.updateObject(attributeJSONString, modifiedAttribute);
