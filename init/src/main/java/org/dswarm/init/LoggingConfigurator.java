...
public final class LoggingConfigurator {
	...
	private static Appender<ILoggingEvent> addFileAppender(final Context lc, final String loggingPath, final String alternative, final Level level) {
	...
	private static Appender<ILoggingEvent> getFileAppender(final Context lc, final Level level, final String basePath, final String name) {
	...
	private static RollingFileAppender<ILoggingEvent> createRollingFileAppender(final Context lc, final String name, final String basePath) {
	...
	private static TimeBasedFileNamingAndTriggeringPolicy<ILoggingEvent> getTriggeringPolicy(final Context lc) {
	...
	private static RollingPolicy getRollingPolicy(final Context lc, final String basePath, final TimeBasedFileNamingAndTriggeringPolicy<ILoggingEvent> triggeringPolicy) {
	...
	private static Filter<ILoggingEvent> getFilter(final Context lc, final Level level) {
	...
	private static Encoder<ILoggingEvent> getEncoder(final Context lc) {
